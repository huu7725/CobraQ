...
class EmbeddingService:
    ...
    # Các model khuyến nghị (multilingual, hỗ trợ tiếng Việt):
    # - paraphrase-multilingual-MiniLM-L12-v2 (nhẹ, nhanh)
    # - paraphrase-multilingual-mpnet-base-v2 (chất lượng cao hơn)
    # - intfloat/multilingual-e5-large (rất tốt nhưng nặng)
    ...
    def __init__(
        ...
        Args:
            ...
            cache_folder: Thư mục cache model (mặc định: ~/.cache/torch/sentence_transformers)
        """
